...
console.log(multipleOf3Regex.test("000")); // should be true
console.log(multipleOf3Regex.test("001")); // should be false
console.log(multipleOf3Regex.test("011")); // should be true
